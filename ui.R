...
"),
                            ...
                            tabPanel("Authors",
                                     h3("Yang Hu"),
                                     h4("Candidate for Doctor of Philosopy, Materials Science & Engineering Department"),
                                     h4("Case Western Reserve University"),
                                     ...
                                     h5(a("Linkedin", href = "https://www.linkedin.com/hp/?dnr=zgOzEiT2KS3JH-VHzmxp3ibZKT9pPJ1tDmpQ"),
                                        a("Google Scholar", href = "https://scholar.google.com/citations?user=-WRm-48AAAAJ&hl=en"),a("Research Gate", href = "https://www.researchgate.net/profile/Yang_Hu48")),
